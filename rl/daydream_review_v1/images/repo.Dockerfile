...
# (.daydream/, patch, git add/commit/push) runs as the agent uid. Defense-
# in-depth: the harness re-chowns the checkout and mirror at launch
# (harness.py:155-157), and this layer is idempotent against that handoff.
